...
export default function Dashboard({ projects, tags, saves, signature }) {
  ...
  const title = activeProj === "all"
    ...
    async function askBrain(text) {
      ...
      const systemPrompt = `You are a creative thinking partner with access to everything this person has saved in Moodbase — their references, inspiration, and research. Help them find patterns, make creative decisions, and think through ideas.\n\nHere is their saved content:\n${context}`;
      ...
      setMessages((m) => [...m, { role: "ai", text: "Could not reach your brain right now." }]);
    } finally {
      setTyping(false);
    }
  }
